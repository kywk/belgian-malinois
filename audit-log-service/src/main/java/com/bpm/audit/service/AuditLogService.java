package com.bpm.audit.service;

import com.bpm.audit.model.AuditLog;
import com.bpm.audit.model.OperationType;
import com.bpm.audit.repository.AuditLogRepository;
...
public class AuditLogService {
    ...
    /**
     * Append-only write with hash chain. Synchronized to guarantee ordering.
     */
    ...
    /**
     * Integrity check: re-compute hash chain for the given date range.
     * Returns broken record IDs if any.
     */
